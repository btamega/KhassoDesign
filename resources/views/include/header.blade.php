			...
			<div class="container">
				<div class="row">
					<div class="col-lg-5 col-md-12 col-12">
						<div class="top-left">
							<ul class="list-main">
								<li><i class="ti-headphone-alt"></i> +33 6 05 70 39 20</li>
								<li><i class="ti-email"></i> karecherif2000@gmail.com</li>
							</ul>
						</div>
					</div>
					<div class="col-lg-7 col-md-12 col-12">
						<div class="right-content">
							<ul class="list-main">
								...
								<li><i class="ti-power-off"></i><a href="{{URL::to('/login')}}">Login</a></li>
							</ul>
						</div>
						<!-- End Top Right -->
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="/"><img src="{{asset("test/KhassoDesign/logo1.jpeg")}}" alt="KhassoDesign"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													...
													<li class="{{ (request()->is('pages*')) ? 'active' : '' }}"><a href="{{URL::to('/pages')}}">Pages</a></li>									
													<li class="{{ (request()->is('blog*')) ? 'active' : '' }}" ><a href="{{URL::to('/blog')}}">Blog<i class="ti-angle-down"></i></a>
														<ul class="dropdown">
